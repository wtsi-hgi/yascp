...
## :warning: Please read this documentation on the nf-core website: [https://nf-co.re/yascp/usage](https://nf-co.re/yascp/usage)
...
```console
nextflow run nf-core/yascp --input samplesheet.csv --genome GRCh37 -profile docker
```
