...
The pipeline will determine which cohort the deconvoluted sample comes from (if any). Each VCF file must contain a unique set of samples with no overlap across files.
