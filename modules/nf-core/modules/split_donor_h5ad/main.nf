process SPLIT_DONOR_H5AD {
    ...
    """
        ...
        --filtered_matrix_h5 ${filtered_matrix_h5_2} \\
        --scrublet ${scrublet} \\
        --samplename ${sample} \\
        --output_dir ./outputs \\
        ...
        sed -i 's|outputs/|${params.outdir}/deconvolution/split_donor_h5ad/${sample}/|g' ${sample}.h5ad.tsv 
        ...
        sed -i 's|outputs/|${params.outdir}/deconvolution/split_donor_h5ad/${sample}/|g' ${sample}__donors.h5ad.tsv
        sed -i s\"/^/$sample\\t/\"g ${sample}.donors.h5ad.tsv 
        sed -i 's|outputs/|${params.outdir}/deconvolution/split_donor_h5ad/${sample}/|g' ${sample}.donors.h5ad.tsv
        #rm donors.list
        #rm donors.h5ad.list
