...
include { PLINK_INDEP_PAIRWISE; PLINK_EXTRACT_PRUNED; GT_MATCH_POOL_IBD as GT_MATCH_INFERED_EXPECTED; ENHANCE_STATS_FILE } from '../genotypes/main'
...
workflow RELATIONSHIPS_BETWEEN_INFERED_EXPECTED {
    ...
    main:
      ...
      ch_versions = ch_versions.mix(JOIN_INFERED_EXPECTED_MERGE.out.versions)
      ...
      PLINK_INDEP_PAIRWISE(sample_name_vcf_no_csi)
      ...
      GT_MATCH_INFERED_EXPECTED(PLINK_EXTRACT_PRUNED.out.ldpruned_vcf,'Expected_Infered',mode)
      //GT_MATCH_INFERED_EXPECTED(sample_name_vcf_no_csi,'Expected_Infered',mode)
      ch_versions = ch_versions.mix(GT_MATCH_INFERED_EXPECTED.out.versions)
      ...
      ch_versions = ch_versions.mix(ENHANCE_STATS_FILE.out.versions)
