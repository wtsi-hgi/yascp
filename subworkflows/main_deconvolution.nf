...
workflow  main_deconvolution {
    ...
    main:
        ...
        ch_vireo_donor_n_cells_tsv = collect_file7(vireo_out_sample_summary_tsv.collect(),"vireo_donor_n_cells.tsv",params.outdir+'/deconvolution/filepaths',0,header_seed)
