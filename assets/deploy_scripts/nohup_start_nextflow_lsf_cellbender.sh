...
echo $RUN_ID | nextflow run $SCRIPT_DIR/../.. -profile sanger -entry JUST_CELLBENDER $INPUT_FILE -c $SCRIPT_DIR/../../assets/deploy_scripts/input_setups/cellbender_profile.nf --nf_ci_loc $PWD -resume > nextflow.nohup.log 2>&1 & 
