...
bsub -R'select[mem>4000] rusage[mem=4000]' -J yascp_cluster -n 1 -M 4000 -o yascp_cluster.o -e yascp_cluster.e -q normal bash /software/hgi/pipelines/yascp_versions/yascp_v1.4/assets/deploy_scripts/nohup_start_nextflow_lsf_recluster.sh  $INPUT_FILE
