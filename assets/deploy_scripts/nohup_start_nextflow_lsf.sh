...
echo $RUN_ID | nextflow run /software/hgi/pipelines/yascp_versions/yascp_v1.2 -profile sanger -c /software/hgi/pipelines/yascp_versions/yascp_v1.2/conf/extra_confs/sanger/base.conf -c $INPUT_FILE --nf_ci_loc $PWD -resume > nextflow.nohup.log 2>&1 & 
