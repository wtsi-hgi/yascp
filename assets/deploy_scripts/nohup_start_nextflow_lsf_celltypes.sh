...
echo $RUN_ID | nextflow run /software/hgi/pipelines/yascp_versions/yascp_v1.4 -profile sanger -entry JUST_CELLTYPES -c $INPUT_FILE  --nf_ci_loc $PWD -resume > nextflow.nohup.log 2>&1 & 
