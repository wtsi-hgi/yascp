...
echo $RUN_ID | nextflow run /software/hgi/pipelines/yascp_versions/yascp_v1.5 -profile sanger -entry JUST_RECLUSTER -c /software/hgi/pipelines/yascp_versions/yascp_v1.5/assets/deploy_scripts/input_setups/recluster_profile.nf $INPUT_FILE  --nf_ci_loc $PWD -resume > nextflow.nohup.log 2>&1 & 
