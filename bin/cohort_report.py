...
if (os.path.exists(f"{path}/deconvolution/vireo/vireo_processed")):
    try:
        try:
            ...
            GT_MATCH = pd.read_csv(f"{path}/deconvolution/vireo/vireo_processed/assignments_all_pools.tsv",sep='\t')
