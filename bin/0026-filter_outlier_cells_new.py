...
def main():
    ...
    outlier_filtering_strategys = 'Azimuth:predicted.celltype.l2;all_together'
    for outlier_filtering_strategy in outlier_filtering_strategys.split(';'):
        ...
        sns_plot.savefig(f'{options.of}-outlier_cells__{cell_qc_column}.png')
        ...
        sns_plot.savefig(f'{options.of}-cell_desity__{cell_qc_column}.png')
