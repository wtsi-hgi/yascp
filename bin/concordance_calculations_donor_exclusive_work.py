...
if __name__ == "__main__":
    ...
    #                         sparse=False, format_list=['GT'])
    # GT_Matched_variants2==GT_Matched_variants
    ...
    result.to_csv('/lustre/scratch123/hgi/teams/hgi/mo11/tmp_projects/cellsnp_optimisations/work/scripts/outs/all_Cardinal_46291_Nov_29_2022_cell_concordance_table.tsv',sep='\t')
